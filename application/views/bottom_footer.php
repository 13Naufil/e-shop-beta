...
<!-- Countdown JS -->
<script src="<?php echo base_url('assets/js/finalcountdown.min.js')?>"></script>
<!-- Nice Select JS -->
<script src="<?php echo base_url('assets/js/nicesellect.js')?>"></script>
<!-- Flex Slider JS -->
<script src="<?php echo base_url('assets/js/flex-slider.js')?>"></script>
<!-- ScrollUp JS -->
<script src="<?php echo base_url('assets/js/scrollup.js')?>"></script>
<!-- Onepage Nav JS -->
<script src="<?php echo base_url('assets/js/onepage-nav.min.js')?>"></script>
<!-- Easing JS -->
